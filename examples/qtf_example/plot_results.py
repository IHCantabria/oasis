"""
Plot results for qtf_example

This script plots the DOF time series for the QTF (2nd order forces) example.
"""
...
def main():
    ...
    # Wave parameters (long time series)
    plotter.wave_height = [1.0]
    plotter.wave_period = [10.0]
    plotter.wave_direction = 0
    plotter.ramp_time = 10.0
