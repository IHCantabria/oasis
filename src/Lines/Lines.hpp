...
public:
	...
	double L, dL, dL0, EA, beta, rho0, d, A, Cdt, Cdn, Cmn, CB, GK, GC, Gmu, Gvc, Dz, Kn, dampCoef, VR, vth, us, ud, deltamax, vstatic, vdynamic, fn;
	...
	arma::mat pos, vel, acc, F, s, xc, zc, dxcds, dzcds, Te, roots, weights, isSlip, posFriccion, ffstick, ffslid;
