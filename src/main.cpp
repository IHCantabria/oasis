...
int main(int argc, char* argv[])
{
    ...
    std::cout << "OASIS: Offshore Advanced Simulation Software" << std::endl << std::endl;
    ...
    try
    {
        ...
        {
            std::cout << "ERROR: No input file found. Expected input/dataProblem.yaml or input/dataProblem.dat"
                      << std::endl;
            return 1;
        }

        std::cout << std::endl << "Creating simulation..." << std::endl;
        ...
        mySim->Run();
        std::cout << std::endl << "Closing simulation..." << std::endl;
        mySim->CloseCase();
    }
