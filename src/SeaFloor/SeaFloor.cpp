...
void SeaFloor::ReadPropertiesASCII(FILE* &pFilePointer) 
{
    ...
    //Ignoro las tres primeras lineas, donde pone "New Floor"
...
arma::field<arma::mat> Flat::projectPoints(arma::mat nodos){
    ...
    arma::mat puntosProyectados = nodos; //aqui se devolveran los puntos ya proyectados
    //INICIALIZACION DE Z
    ...
    puntosProyectados.col(2)=fondo*arma::ones(numNodos,1);
